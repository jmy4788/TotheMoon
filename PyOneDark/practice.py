...
class GetDatafromServer():
    ...
    dist: str= "", 
    path: str = r"C:\Programming\python\TotheMoon\PyOneDark\Data_Storage"
    ) -> None:
    ...
    def get_data(self):
        ...
        while self.start_time_ts < self.end_time_ts:
            ...
            if self.dist == "15m":
                self.path = r'C:\Programming\python\TotheMoon\PyOneDark\Data_Storage\15m'
                self.start_time_ts += 15 * 60 * 500 * 1000
            elif self.dist == "1h":
                self.path = r'C:\Programming\python\TotheMoon\PyOneDark\Data_Storage\1h'
                self.start_time_ts += 3600 * 500 * 1000
            elif self.dist == "4h":
                self.path = r'C:\Programming\python\TotheMoon\PyOneDark\Data_Storage\4h'
                self.start_time_ts += 4 * 3600 * 500 * 1000
            elif self.dist == "1d":
                self.path = r'C:\Programming\python\TotheMoon\PyOneDark\Data_Storage\1d'
...
if __name__ == "__main__":
    test_data = GetDatafromServer(dist="4h")
    test_data.set_start_time("2022-02-11 12:00:00")
    test_data.set_end_time("2023-02-11 12:00:00")
    test_data.get_data()